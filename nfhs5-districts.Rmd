...
For this analysis, we use data downloaded from https://github.com/pratapvardhan/NFHS-5, which in turn was compiled from the NFHS-5 state and district fact sheets.
